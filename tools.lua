...
--local finalword ={}
 ...
 --end
 --for i, wor in ipairs(words) do
	--for t, er in ipairs(dico)  do
		--if er~= wor then
			--table.insert(finalword,string.lower(wor))
			--break
		--else 
			--table.insert(finalword,string.lower(dico[3]))
			--break
		--end
 --end
 --end
 ...
 --for i, wor in ipairs(wordn) do
  --for p, dic in ipairs(dico) do
	--if wor==dic then
	 --table.insert(words,string.lower(dico[3]))
	 --end
--end
--end
--tprint(finalword)
